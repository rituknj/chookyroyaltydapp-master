...
export default function Main({ account, Dissconnect, Metamask, WalletC }) {
  ...
  const stake = async () => {
    if (52500 > amount) {
      warn(
        "Minimum lock amount for ETH rewards is 52500 $CHOO or 0.25% of total supply."
      );
      return;
    }
  ...
  // console.log(Number(tier4) / Number(holder4));
      ...
      >
        ...
        <div className="container">
          <div>
            ...
            <div className="row staked-field">
              {" "}
              ...
              <div className="col-lg-3 col-md-6 col-sm-12 col-12 ">
                <button
                  className="claim-bu1"
                  id="staked-more staked-more1"
                  onClick={() => {
                    stake();
                    setShow3(2);
                  }}
                >
                  {userStakeBalance > 0 ? "ADD MORE" : "LOCK $CHOO"}
                </button>
              </div>
              <div className="col-lg-3 col-md-6 col-sm-12 col-12 ">
                {userStakeBalance > 0 ? (
            ...
            <div className="row main-new-table main-new-table-choo">
            ...
            <div className="row main-new-table">
              <div className="col-lg-4 col-md-6 col-sm-6 col-6">
                {" "}
                <div className="main-content">
                  <p className="table-para" style={{ fontWeight: "700" }}>
              ...
              <div className="col-lg-8 col-md-6 col-sm-6 col-6">
                {" "}
                <div className="main-content d-flex">
                  <p className="table-para">{userStakeBalance}</p>
                  <span className="table-para-chooky">$CHOO</span>
                </div>
              </div>
            </div>
            {tier == "-1" ? (
              ...
              <div className="row">
                ...
                <div className="col-lg-8 col-md-6 col-sm-6 col-6">
                  {" "}
                  <div className="main-content" style={{ color: "#fff" }}>
                    {account ? (
                ...
                <div className="main-content">
                  <p className="table-para">
                    ...
                    {/*           {lasttime != 0 && lasttime + 60000 < current ? (
                      <button className="claim-bu" onClick={() => claim()}>
                        CLAIM
                      </button>
                    ) : (
                      ""
